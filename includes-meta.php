<footer class="blog-meta">
	<ul class="clearfix">
		...
		<?php if(comments_open() || get_comments_number() > 0) { // get_comments_number used in lieu of have_comments because have_comments only works when in the main wp_query loop ?>
